...
#define MASK_DAY 6
#define MASK_HOUR 7
#define MASK_MINUTE 8
#define MASK_SECOND 9
#define MASK_COPULA 10


unsigned char masksCore[11][BYTE_COUNT] =
{
  { B11000000,
    B00000000,
    B00000000,
...
};//end of masksNumbersA

unsigned char masksNumbersB[15][BYTE_COUNT] = 
{
  { B00000000,
    B00000000,
    B00000000,
...
unsigned char masksNumbersC[15][BYTE_COUNT] = 
{
  { B00000000,
    B00000000,
    B00000000,
...
unsigned char letters[SYMBOL_COUNT][BYTE_COUNT] = {
